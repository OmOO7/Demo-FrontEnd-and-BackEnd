...
jQuery(document).ready(function () { }), $("#option1").click(function () {
    $("#DivAdd").show(), $("#DivList").hide(), $("#option1").hide(), $("#option2").show(), $(SpanTitle).html("add Admin")
}), $("#option2").click(function () {
    $("#DivAdd").hide(), $("#DivList").show(), $("#option1").show(), $("#option2").hide(),GetData(), $(SpanTitle).html("Admin List")
})
  ...
  Reset(), $.ajax({
        ...
        success: function (e) {
            if (null != e && void 0 !== e) {
                ...
                for (var n = 0; n < r.result.length; n++) $("#compact").append("<tr><td>" + r.result[n].UserName + " </td><td>" + r.result[n].FullName + " </td><td>" + r.result[n].Email + " </td><td>" + r.result[n].Mobile + " </td><td>" + r.result[n].Dob + " </td><td>" + r.result[n].Nationality + " </td><td>" + r.result[n].CityName + "</td><td>" + r.result[n].SecretKey+ "</td></tr>");
